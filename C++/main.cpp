...
public:
    ...
    void load_data(string roadmap)
    {
        ...
        for (auto &item : j_data)
        {
            ...
            n.Details = item["Details"].get<vector<string>>();
        }
        file.close();
    }
...
int main()
{
    ...
    while (true)
    {
        ...
        // search_dictionary.dict.count(search_key) > 0 &&
        if (search_dictionary.dict[search_key].in_roadmap)
        {
            ...
            if (choice == "y" || choice == "Y")
            {
                ...
                for (const string &roadmap_file : search_dictionary.dict[search_key].roadmap)
                {
                    ...
                    // Load roadmap into temp vector<string>
                    if (rm_choice == 1)
                    {
                    ...
                    // // Print details
                    // cout << "Is there any stage in the roadmap that you want to be provided with more details ? [[n/N] if you don't] \n";
                    // string details_choice;
                    // do
                    // {
                    //     getline(cin, details_choice);
                    //     details_choice = slugify(details_choice);
                    //     auto it = find(roadmap_print.begin(), roadmap_print.end(), details_choice);
                    //     if (details_choice != "n" && it == roadmap_print.end())
                    //     {
                    //         cout << "Invalid input! \n";
                    //         continue;
                    //     }
                    //     else if (details_choice != "n")
                    //     {
                    //         for (auto &i : rc.node_list[it - .begin()])
                    //         {
                    //             cout << i << "\n";
                    //         }
                    //     }
                    // } while (details_choice != "n");
                }
                cout << "---------------------------------------------------------\n";
            }
            cin.ignore(1000, '\n');
